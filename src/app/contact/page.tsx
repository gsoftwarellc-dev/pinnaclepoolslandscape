        ...
        <div>
          <div className="grid gap-8 sm:grid-cols-2">
            <div>
              ...
              <a href={business.phoneHref} className="mt-1 block text-[#0f4c92]">
                {business.phone}
              </a>
            ...
            <div>
              ...
              <a href={`mailto:${business.email}`} className="mt-1 block text-[#0f4c92]">
                {business.email}
              </a>
            </div>
            <div>
          ...
          <div className="mt-10">
            ...
            <div className="mt-3 flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-300 text-slate-700 hover:border-[#1668c4] hover:bg-[#1668c4] hover:text-white"
              >
